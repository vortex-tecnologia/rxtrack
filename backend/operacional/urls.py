...
urlpatterns = [
    ...
    path('api/manifesto/detalhes-modal/<str:manifesto_id>/', views.detalhes_manifesto_modal_view, name='detalhes_manifesto_modal'),
    ...
    path('api/cargas-fretes/detalhes/', views.api_cargas_fretes_detalhes, name='api_cargas_fretes_detalhes'),
